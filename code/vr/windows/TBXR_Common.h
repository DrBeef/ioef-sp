/*
===========================================================================
TBXR_Common.h -- Team Beef OpenXR common layer (Windows/PCVR).

Ported/adapted from RealRTCWXR (code/RealRTCWXR/RealRTCWXR/windows/
TBXR_Common.h) for the ioEF Elite Force OpenXR VR port (milestone M1).

Engine-agnostic OpenXR + OpenGL helper types and the TBXR/VR prototypes.
LOG_TAG/messages rebranded to "EFXR".  M1 keeps the controller/haptics
prototypes so TBXR_Common.c links, but the bodies live in EFXR_SurfaceView.c
(stubbed for M1) -- nothing in the engine calls them yet.
===========================================================================
*/
...
// Engine glue provided by EFXR_SurfaceView.c so TBXR_Common.c stays
// engine-agnostic (it never touches cls/clc/re directly).
